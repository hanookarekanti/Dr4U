    ...
    return profileData && (
        <div>
            <div className='flex flex-col gap-4 m-5'>
                <div>
                    <img className='w-full sm:max-w-64 rounded-full ' src={profileData.image} alt="" />
                </div>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    {
                        isEdit
                            ? <button onClick={updateProfile} className='px-4 py-1 border border-[#f78f4a] text-sm rounded-full mt-5 hover:bg-[#f78f4a] hover:text-black transition-all'>Save</button>
                            : <button onClick={() => setIsEdit(prev => !prev)} className='px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-[#f78f4a] hover:text-black transition-all'>Edit</button>
                    }
